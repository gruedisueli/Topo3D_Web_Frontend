...
// import VoxelViewer from './composables/useVoxelVisualization.ts/index.js'
...
// import HoverViewer from './components/hoverViewer.vue'
// import ThreeScene from './components/threeScene.vue'
// import type { useVoxelVisualization } from './composables/useVoxelVisualization.ts'
...
//   const threeScene = threeSceneRef.value
//   if (threeScene && threeScene.scene && viewer.camera && viewer.renderer && viewer.orbitControls) {
...
//   voxelViewerShouldClear.value = true // voxelViewerRef.value?.clear()
//   //stlViewerRef.value?.clear()
...
// function handleVoxelViewerClearComplete() {
//   voxelViewerShouldClear.value = false
// }

// function handleStlViewerClearComplete() {
//   stlViewerShouldClear.value = false
// }
</script>
